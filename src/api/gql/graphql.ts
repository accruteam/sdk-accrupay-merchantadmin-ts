...
export type MerchantPaymentPlanFragmentFragment = { __typename?: 'MerchantPaymentPlan', id: string, merchantInternalPaymentPlanCode: string, merchantInternalPaymentPlanDescription?: string | null, merchantInternalCustomerCode: string, amount: bigint, initialAmount: bigint, currency: CURRENCY, providerCode: string, providerError?: string | null, providerLastSyncedAt?: any | null, providerLastVerifiedAt: any, providerStatus: PAYMENT_PLAN_STATUS, status: PAYMENT_PLAN_STATUS, renewalIntervalDays: number, renewalIntervalMonths: number, renewalIntervalYears: number, endsAfterDays: number, endsAfterMonths: number, endsAfterYears: number, trialPeriodDays: number, trialPeriodMonths: number, trialPeriodYears: number, periodCount: number, timeAnchor: any, currentPeriodStart: any, currentPeriodEnd: any, startedAt?: any | null, endsAt: any, trialEndsAt: any, canceledAt?: any | null, paymentMethodId: string, templateId?: string | null, transactionProviderId: string, payload: any, createdAt: any, updatedAt: any, paymentMethod: { __typename?: 'MerchantCustomerPaymentMethod', id: string, isDefault: boolean, isEnabled: boolean, merchantInternalCustomerCode: string, methodType: PAYMENT_METHOD, providerCode: string, providerError?: string | null, providerLastSyncedAt?: any | null, providerLastVerifiedAt: any, providerStatus: PAYMENT_METHOD_STATUS, transactionProviderId: string, billingFirstName?: string | null, billingLastName?: string | null, billingEmail?: string | null, billingPhone?: string | null, billingAddressLine1?: string | null, billingAddressLine2?: string | null, billingAddressCity?: string | null, billingAddressState?: string | null, billingAddressCountry?: COUNTRY_ISO_2 | null, billingAddressPostalCode?: string | null, createdAt: any, updatedAt: any, paymentMethodInfo?: { __typename?: 'MerchantCustomerPaymentMethodAchInfo', methodType: PAYMENT_METHOD, accountNumber?: string | null, routingNumber?: string | null, secCode?: TRANSACTION_ACH_SECCODE | null } | { __typename?: 'MerchantCustomerPaymentMethodCreditCardInfo', methodType: PAYMENT_METHOD, cardBrand?: string | null, cardNumberMasked?: string | null } | { __typename?: 'MerchantCustomerPaymentMethodGenericInfo', methodType: PAYMENT_METHOD } | null }, template?: { __typename?: 'MerchantPaymentPlanTemplate', id: string, name: string, description?: string | null, amount: bigint, initialAmount: bigint, currency: CURRENCY, providerCode: string, providerError?: string | null, providerLastSyncedAt?: any | null, providerLastVerifiedAt: any, providerStatus: PAYMENT_PLAN_TEMPLATE_STATUS, transactionProviderId: string, renewalIntervalDays: number, renewalIntervalMonths: number, renewalIntervalYears: number, endsAfterDays: number, endsAfterMonths: number, endsAfterYears: number, trialPeriodDays: number, trialPeriodMonths: number, trialPeriodYears: number, payload: any, createdAt: any, updatedAt: any } | null, transactionProvider: { __typename?: 'MerchantTransactionProvider', id: string, merchantId: string, provider: TRANSACTION_PROVIDER, providerCode: string, status: MERCHANT_TRANSACTION_PROVIDER_STATUS, createdAt: any, updatedAt: any } };
